...
namespace Moisi_Vanesa_Lab2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Moisi_Vanesa_Lab2.Data.Moisi_Vanesa_Lab2Context context)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                // Codul de salvare a membrului este MUTAT AICI
            ...
            // Eroarea este returnată ca Page() doar dacă result.Succeeded este false
