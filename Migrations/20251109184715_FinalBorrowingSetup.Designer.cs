...
namespace Moisi_Vanesa_Lab2.Migrations
{
    ...
    [Migration("20251109184715_FinalBorrowingSetup")]
    partial class FinalBorrowingSetup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moisi_Vanesa_Lab2.Models.Author", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Moisi_Vanesa_Lab2.Models.Book", b =>
                {
                    b.HasOne("Moisi_Vanesa_Lab2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Moisi_Vanesa_Lab2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Moisi_Vanesa_Lab2.Models.BookCategory", b =>
                {
                    b.HasOne("Moisi_Vanesa_Lab2.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Moisi_Vanesa_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("Moisi_Vanesa_Lab2.Models.Borrowing", b =>
                {
                    ...
                    b.HasOne("Moisi_Vanesa_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
